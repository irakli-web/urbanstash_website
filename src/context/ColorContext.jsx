...
export const PALETTE = [
  ...
  // Row 1
  { name: 'Linen', hex: '#EDE0C9' },
  { name: 'Peach Blush', hex: '#FDD7C4' },
  { name: 'Nude Rose', hex: '#FECEBF' },
  { name: 'Flamingo', hex: '#FFA493' },
  { name: 'Petal', hex: '#F8E0E8' },
  { name: 'Cotton Candy', hex: '#FFC2C2' },
  { name: 'Bubblegum', hex: '#FFACBB' },
  { name: 'Hot Pink', hex: '#FF6F8F' },
  // Row 2
  { name: 'Butter', hex: '#FDEFD2' },
  { name: 'Apricot', hex: '#F8D5B9' },
  { name: 'Tangerine', hex: '#FFBB92' },
  { name: 'Mango', hex: '#FC996F' },
  { name: 'Blush Pink', hex: '#FFBBBA' },
  { name: 'Rose Quartz', hex: '#F4B7C2' },
  { name: 'Blush Mist', hex: '#FEDCDA' },
  { name: 'Periwinkle', hex: '#C2C8E5' },
  // Row 3
  { name: 'Spearmint', hex: '#AFFFD5' },
  { name: 'Lime Zest', hex: '#D7FFBA' },
  { name: 'Sage', hex: '#BDE9C8' },
  { name: 'Mist Green', hex: '#E2F2D7' },
  { name: 'Electric Lime', hex: '#E2FD58' },
  { name: 'Flash Yellow', hex: '#F7F64A' },
  { name: 'Ice Blue', hex: '#E6FFFE' },
  { name: 'Lilac', hex: '#B3B0FF' },
  // Row 4
  { name: 'Seafoam Bright', hex: '#BDFFE0' },
  { name: 'Pistachio', hex: '#BBEDA6' },
  { name: 'Spring Green', hex: '#B6FFBA' },
  { name: 'Aquamarine', hex: '#95FAC7' },
  { name: 'Powder Blue', hex: '#D5FCE8' },
  { name: 'Cornflower', hex: '#C1DCF1' },
  { name: 'Sky', hex: '#BEE7FF' },
  { name: 'Lavender Blue', hex: '#9A93FF' },
  // Row 5
  { name: 'Neon Green', hex: '#95ED82' },
  { name: 'Pale Moss', hex: '#C3E3AB' },
  { name: 'Jade', hex: '#79F9A5' },
  { name: 'Caribbean', hex: '#99FBDA' },
  { name: 'Cornflower Blue', hex: '#93C1FF' },
  { name: 'Frost', hex: '#DAF2F2' },
  { name: 'Crimson', hex: '#7E0001' },
  { name: 'Electric Indigo', hex: '#4A3CFF' },
  // Row 6
  { name: 'Neon Lime', hex: '#73FE7D' },
  { name: 'Celadon', hex: '#B9EFA3' },
  { name: 'Fern', hex: '#6ED392' },
  { name: 'Turquoise', hex: '#7FE0B3' },
  { name: 'Mocha', hex: '#56352C' },
  { name: 'Burgundy', hex: '#5B1A22' },
  { name: 'Graphite', hex: '#323439' },
  { name: 'Royal Blue', hex: '#463C9F' },
];
