...
export default function UnitsPage() {
  return (
    <div className="min-h-screen bg-theme text-white">
      ...
      <main>
        {/* Hero */}
        <section className="hero-section relative py-20 md:py-28 px-4 md:px-6 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            <p className="hero-subtitle text-zinc-500 text-lg">{locations.length} location{locations.length !== 1 && 's'} found</p>
          </div>
        </section>
