...
const IMG_CITY =
  'https://images.unsplash.com/photo-1449965408860-eaa67f0e8c0a?w=800&h=600&fit=crop&q=80';
...
export default function AboutPageV2() {
  return (
    <div className="min-h-screen bg-black text-white">
      <HeaderV2 />
      <main>
        {/* ── Hero — editorial style matching reference ── */}
        <section className="relative py-28 md:py-40 px-4 md:px-6 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <p className="text-zinc-400 text-lg md:text-xl max-w-lg leading-relaxed mb-10">
        ...
        <section className="bg-charcoal py-24 md:py-32 px-4 md:px-6 border-t border-white/[0.04] relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tight text-center mb-20">
