      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
          ...
          <div className="flex gap-4 text-zinc-400">
            ...
            <a href="#" className="p-2 hover:text-white transition-colors" aria-label="LinkedIn">
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between gap-6">
          <p className="text-zinc-500 text-sm">
            32 Mercer St, New York, NY 10013, United States
          </p>
